...
export const actionPolicies: Readonly<Record<ActionKey, ActionPolicy>> = {
  ...
  REQUEST_APPROVAL: { humanPermission: 'approvals.read', serviceCapability: 'approvals.request', approval: 'NONE' },
  READ_APPROVALS: { humanPermission: 'approvals.read', approval: 'NONE', servicesForbidden: true },
  DECIDE_APPROVAL: { humanPermission: 'approvals.decide', approval: 'NONE', servicesForbidden: true },
